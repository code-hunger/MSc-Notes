  ...
  [
    ...
    *basic* solutions.
    ...
    #align(
      ...
      [one particular solution\ of $A x_0=b$] , $+$ , [a solution of\ the homogeneous system\ $A x=0$])
    )
    $ x_0 + x $

    Different choices for $x_0$ give rise to different representations of the solution space.
  ]
)
